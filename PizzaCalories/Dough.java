...
public class Dough {
    ...
    private static final Map<String, Double> FLOUR_TYPES = Map.of("White", 1.5, "Wholegrain", 1.0);
    private static final Map<String, Double> BACKING_TECHNIQUES = Map.of("Crispy", 0.9, "Chewy", 1.1, "Homemade", 1.0);
